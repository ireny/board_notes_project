  ...
  tbody.innerHTML = projects
    ...
    <tr>
      ...
      <td class="text-end pe-4">
        <a href="/project/${project.id}/tasks" data-link class="action-icon" title="View Tasks">
        ...
        <a href="/projects/${project.id}/users" data-link class="btn btn-sm btn-outline-primary me-1" title="Manage Users">Users</a>
